...
const slscrypt = require('serverless-crypt/dists/slscrypt');

console.log('Loading gbg-graphql lambda')
const appIdPromise = slscrypt.get('GBG_APPID');

// Current latest version of GraphiQL.
var GRAPHIQL_VERSION = '0.8.0';

module.exports.gbggraphql = (event, context, callback) => {
	console.log('The input event is: ', JSON.stringify(event))
	if ("GET" == event.httpMethod) {
		...
		console.log('The GraphQL query is: ', query)

		appIdPromise.then((txt) => {
			console.log('GBG_APPID decrypted/read.')
			process.env.GBG_APPID = txt
